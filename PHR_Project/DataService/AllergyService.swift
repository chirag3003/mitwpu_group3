...
class AllergyService {
    ...
    // Synchronous Return for UI which returns cached data
    ...
    func fetchAllergiesFromAPI() {
        APIService.shared.request(endpoint: "/allergies", method: .get) {
            [weak self] (result: Result<[Allergy], Error>) in
