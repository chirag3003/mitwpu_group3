...
class DocDoctorService {
    ...
    func fetchDoctorsFromAPI() {
        APIService.shared.request(endpoint: "/docDoctors", method: .get) { [weak self] (result: Result<[DocDoctor], Error>) in
    ...
    func createDoctor(name: String) {
        ...
        APIService.shared.request(endpoint: "/docDoctors", method: .post, body: newDoctor) { [weak self] (result: Result<DocDoctor, Error>) in
            guard let self = self else { return }
    ...
    func deleteDoctor(id: String) {
        ...
        APIService.shared.request(endpoint: "/docDoctors/\(id)", method: .delete) { (result: Result<EmptyResponse, Error>) in
