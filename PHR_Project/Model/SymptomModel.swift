...
struct Symptom: Codable {
    ...
    // Custom Struct for Time decoding/encoding
    ...
    init(id: UUID? = nil, apiID: String? = nil, symptomName: String, intensity: String, dateRecorded: Date, notes: String?, time: DateComponents) {
        self.id = id
        self.apiID = apiID
    ...
    init(from decoder: Decoder) throws {
        ...
        self.dateRecorded = try container.decode(Date.self, forKey: .dateRecorded)
