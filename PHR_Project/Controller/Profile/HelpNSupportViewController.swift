...
class HelpNSupportViewController: UIViewController {
    ...
    private let contactOptions:
        [(icon: String, title: String, subtitle: String, tag: Int)] = [
    ...
    private func setupContent() {
        // FAQ Section
        let faqSection = createSectionContainer(
            title: "Frequently Asked Questions"
        )
        for (index, item) in faqItems.enumerated() {
            let faqCard = createFAQCard(
        ...
        -> UIView
    {
        ...
        questionLabel.textColor = UIColor(
            red: 100 / 255,
            green: 180 / 255,
            blue: 255 / 255,
            alpha: 1
    ...
    private func createContactCard(
        icon: String,
        title: String,
        subtitle: String,
        tag: Int
        ...
        card.addTarget(
            self,
            action: #selector(handleContactAction(_:)),
            for: .touchUpInside
        )
        card.tag = tag
    ...
    private func createQuickLinkCard(
        icon: String,
        title: String,
        subtitle: String
    ) -> UIView {
        ...
        card.addTarget(
            self,
            action: #selector(handleQuickLinkTapped),
            for: .touchUpInside
        )
    ...
    private func createAppInfoSection() -> UIView {
        ...
        appIconImageView.tintColor = UIColor(
            red: 100 / 255,
            green: 180 / 255,
            blue: 255 / 255,
            alpha: 1
